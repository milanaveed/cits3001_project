...
DATA_DIR = './reinforcement-learning/train2-1-v3/'
os.makedirs(DATA_DIR, exist_ok=True)
LOG_DIR = './reinforcement-learning/logs2-1-v3/'
    ...
    def _on_step(self):
        if self.n_calls % self.check_freq == 0:  # Checks whether the current number of steps is a multiple of check frequency that we set
            ...
            model_path = os.path.join(
                self.save_path, '2-1_v3model_{}'.format(self.n_calls))  # Saves the model
            ...
            print('pass rate:', round(number_of_pass/NUMBER_OF_TRIALS*100))
            print('####################################################')
